 ...
 */
return array (
	"'%value%' is not among the allowed hostname values : %hosts%" => "'%value%' n'est pas dans la liste des nom d'hôtes autorisés : %hosts%",
    ...
    "'%value%' is more than %max% characters long" => "La taille de l'entrée est supérieure à %max% caractères",
